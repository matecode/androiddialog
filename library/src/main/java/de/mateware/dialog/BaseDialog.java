...
public class BaseDialog<T extends BaseAlertDialogBuilderInterface, K extends android.app.Dialog, M extends BaseDialogInterface> {
...
//                                                                                                             .getSimpleName());
    ...
    public BaseDialog(M dialogFragment) {
    ...
    public void onAttach(Context context) {
        try {
            buttonListener = (DialogButtonListener) context;
        ...
        try {
            cancelListener = (DialogCancelListener) context;
        } catch (ClassCastException e) {
            log.warn(e.getMessage());
        }
    ...
    protected K createDialogToReturn() {
        return (K) builder.create();
    }
    ...
    static class AbstractBaseBuilder<T extends AbstractBaseBuilder, K extends BaseDialogInterface> {
        Bundle builderArgs = new Bundle();
        boolean cancelable = true;

        private Class<K> clazz;

        AbstractBaseBuilder(Class<K> clazz) {
            this.clazz = clazz;
        }
